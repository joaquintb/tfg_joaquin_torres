...
# ------------------------------------------------------------------------------------------------------
# This code includes adaptations from Ben Moseley's 2022 work, available under the MIT License.
# Original source can be found at:
# https://github.com/benmoseley/harmonic-oscillator-pinn-workshop/blob/main/PINN_intro_workshop.ipynb
#
# This code also incorporates adaptations from Vanessa García López's 2022 work.
# Original source can be accessed here:
# https://github.com/vgarcialopezm/ABC-SMC/blob/main/LV.ipynb
# ------------------------------------------------------------------------------------------------------
...
def simulate(t_obs, u_obs_x, u_obs_y, t_physics, target_params, tol, max_its, lambda_weight):
    ...
    for it in range(max_its):
        ...
        if a_done and b_done and c_done and d_done:
            ...
            # returns: a_s, a_times, b_s, b_times, c_s, c_times, d_s, d_times, final_time, stopped 
...
if __name__=="__main__": 
    ...
    #                                    SIMULATION LOOP
    # ------------------------------------------------------------------------------------------------------
    # Set up a figure with 4 subplots: a,b,c,d
